...
<template>
  ...
  <NuxtLayout name="expanded">
    ...
    <template #content>
      <section id="drawflow-graph" ref="drawflow"></section>
    </template>
  </NuxtLayout>
  </div>
</template>
...
:root {
  ...
  --dfBackgroundImage: linear-gradient(to right, rgba(215, 215, 215, 0.2) 1px, transparent 1px), linear-gradient(to bottom, rgba(230, 230, 230, 0.2) 1px, transparent 1px);
